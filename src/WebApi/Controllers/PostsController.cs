...
public class PostsController : ApiControllerBase
{
    ...
    {
        Guid result = await Mediator.Send(new AddCommentRequest
        {
            PostId = postId!.Value,
    ...
    {
        Guid result = await Mediator.Send(new CreatePostCommand
        {
            Content = body.Content,
    ...
    {
        Guid result = await Mediator.Send(new AddSubCommentRequest
        {
    ...
    {
        PostDto result = await Mediator.Send(
